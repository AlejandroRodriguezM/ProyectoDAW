            ...
            <div class="container mt-5" style="margin-top:auto !important;">
                <div class="row">
                    <div class="col-md-3 side-bar">
                        ...
                        <div class="user-info">
                            <img class='img-profile img-circle img-fluid w-100 h-auto comic_portada' id='output' alt='Avatar' src='<?php echo $cover ?>' onclick='pictureProfileUser()' />
                            <?php
                            ...
                            <div class="view-account bg-light" style="border-radius:20px">
                                        ...
                                        <table class='table'>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class='comic-value'><?php echo $numero_comic ?></span></td>
                                                </tr>
                                                <tr>
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <div class="form-group bg-light p-3 rounded">
                                        <p><?php echo $descripcion_comic ?></p>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
