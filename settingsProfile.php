                    ...
                    <div class="side-bar">
                        <div class="user-info">
                            ...
                            <ul class="meta list list-unstyled">
                                <li class="name"><label for="" style="font-size: 0.8em;">Nombre:</label> <?php
                                                                                $email = $_SESSION['email'];
                                                                                $dataUser = getUserData($email);
                                ...
                                <li class="email"><label for="" style="font-size: 0.8em;">Mail: </label><?php
                                                                                $email = $_SESSION['email'];
                                                                                $dataUser = getUserData($email);
                        ...
                        <nav class="side-menu">
                            <ul class="nav">
                                ...
                                <li class="active"><a href="#"><span class="fa fa-cog"></span> Settings</a></li>
