                                                ...
                                                <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
                                                    <ul class="nav nav-pills flex-column mb-auto">
                                                        ...
                                                        ?>
                                                                ...
                                                                <li>
                                                                    <a href="admin_actualizar_usuario.php?id_usuario=<?php echo $id_otros_usuario ?>" class="nav-link link-dark">
                                                                        <span class='fa fa-user'></span>&nbsp;Editar</a>
                                                                </li>
                                                                <li>
                                                                    <a href="admin_mensajes_usuarios.php?id_usuario=<?php echo $id_otros_usuario ?>" class="nav-link link-dark ">
