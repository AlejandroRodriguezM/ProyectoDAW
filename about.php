...
<body class="d-flex flex-column min-vh-100" onload="checkSesionUpdate();showSelected();">
    <main class="flex-shrink-0">
        ...
        <div class="bg-image bg-attachment-fixed" style="background-image: url('assets/img/img_parallax.jpg');opacity: 0.8;">
            <br>
            <div class="card text-center container mt-5 bg-dark">
                <div class="card-header text-light">
                    <h1 class="display-4 text-light">Librería Online de Comics</h1>
                    <h3 class="lead text-light">Organiza tus lecturas y conoce a gente con gustos parecidos</h3>
                </div>
                <div class="card-body">
                    <p class="lead text-light">
                        Bienvenido a Comic web, la librería online de cómics que te permite tener tus lecturas organizadas y al día.
                        Además, en nuestra página podrás conocer a gente con gustos parecidos y compartir tus listas de lecturas personalizadas.
                    </p>
                    <p class="lead text-light">
                        Hemos diseñado una página web fácil de usar e intuitiva, utilizando tanto front-end como back-end, y hemos incluido una base de datos MySQL para almacenar la información de nuestros usuarios y sus listas de lecturas.
                        Siempre estamos añadiendo nuevas funcionalidades a nuestro proyecto, y puedes ver nuestras notas de funcionalidad en nuestro repositorio de GitHub.
                    </p>
                    <p class="lead text-light">
                        Comic web es una librería online de cómics que te permite tener tu lectura ordenada.
                        En nuestra página, también puedes conocer a gente con gustos parecidos y compartir
                        tus listas de lecturas personalizadas. Hemos diseñado una página web fácil de usar e
                        intuitiva, utilizando tanto front-end como back-end, y hemos incluido una base de datos
                        MySQL para almacenar la información de nuestros usuarios y sus listas de lecturas.
                        Siempre estamos añadiendo nuevas funcionalidades a nuestro proyecto, y puedes ver
                        nuestras notas de funcionalidad en nuestro repositorio de GitHub.
                    </p>
                    <div class="d-flex justify-content-center align-items-center">
                        <a href="https://github.com/AlejandroRodriguezM" style="background-color: transparent" target="_blank">
                            <img src="./assets/img/github.png" alt="Github" width="80" height="80">
                        </a>
                        <a href="https://www.linkedin.com/in/alejandro-rodriguez-mena-497a00179/" style="background-color: transparent" target="_blank">
                            <img src="https://brand.infojobs.net/downloads/ij-logo_reduced/ij-logo_reduced.svg" alt="infoJobs" width="50" height="50">
                        </a>
                    </div>
                </div>
            </div>
