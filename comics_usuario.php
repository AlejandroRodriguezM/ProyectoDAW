...
if (isset($_GET['id_usuario'])) {
    ...
    $data_otro_usuario = obtener_datos_usuario($id_otro_usuario);
...
<body class="d-flex flex-column min-vh-100" onload="checkSesionUpdate();showSelected();">
    <div class="bg-image bg-attachment-fixed" style="background-image: url('assets/img/img_parallax.jpg');background-size: cover;
    ...
    <script>
        ...
        function loadComics(offset = 0) {
            ...
            var data = {
                limit: limit,
                offset: offset,
                id_user: '<?php echo $id_otro_usuario; ?>' //id del usuario que se está viendo
            };
