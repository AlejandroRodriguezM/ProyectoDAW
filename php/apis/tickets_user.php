...
$tickets = getTickets_user($id_user);
    ...
    foreach ($tickets as $ticket) {
        ...
        if (!empty($conversations)) {
            ...
            foreach ($conversations as $conversation) {
              if($conversation['privilegio_user'] == 'user'){
                echo "<p style='color: red'><strong>Tu mensaje: </strong>" . $conversation['respuesta_ticket'] . "<br> - Hora de mensaje: " . $conversation['fecha_respuesta'] . "</p>";
              }
              else{
                echo "<p style='color: blue'><strong>Mensaje de administrador: </strong>" . $conversation['respuesta_ticket'] . "<br> - Hora de mensaje: " . $conversation['fecha_respuesta'] . "</p>";
              }
            }
        } else {
