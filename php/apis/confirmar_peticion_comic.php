...
if ($userPrivilege != 'guest') {
    ...
    if ($_POST) {
        if (confirmar_solicitud_datos_comic($nombre_comic,$nombre_variante,$numero,$formato,$editorial,$fecha,$guionista,$procedencia,$descripcion,$dibujante,$portada_comic)) {
            $id_comic = ultimo_id_comic($nombre_tabla_peticiones);
            portadas_confirmadas($portada_comic,$id_comic);
            direccion_imagen_comic_confirmado($id_comic);
