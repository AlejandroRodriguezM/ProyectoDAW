            ...
            <div class="bg-white p-1">
                ...
                <form id="formInsert" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <input type="email" class="form-control" id="correo" placeholder="name@test.com">
                    </div>
                    <div class="mb-3 text-center">
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <input class="form-control" type="file" name="files" id="files" accept=".jpg, .png" onchange="loadFile(event)">
                    </div>
                    <div class="mb-3 text-center">
