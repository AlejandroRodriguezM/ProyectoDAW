                            ...
                            <div class="side-bar">
                                ...
                                <nav class="side-menu">
                                    <ul class="nav">
                                        ...
                                        <li class="active"><a href="admin_panel_peticiones_comic.php"><span class="fa fa-cog"></span>Peticiones de comics</a></li>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data as $row) {
                                                    ...
                                                    <button class='btn btn-success' onclick=\"cancelar_peticion_usuario($id_comic); return false;\">
